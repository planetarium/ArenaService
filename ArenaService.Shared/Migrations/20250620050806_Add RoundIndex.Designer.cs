...
namespace ArenaService.Shared.Migrations
{
    ...
    [Migration("20250620050806_Add RoundIndex")]
    partial class AddRoundIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArenaService.Shared.Models.AvailableOpponent", b =>
                {
                    ...
                    b.HasIndex("AvatarAddress", "RoundId", "DeletedAt")
                        .HasDatabaseName("ix_available_opponents_avatar_address_round_id_deleted_at");

                    b.HasIndex("RoundId", "AvatarAddress", "OpponentAvatarAddress", "SuccessBattleId", "DeletedAt")
                        .HasDatabaseName("ix_available_opponents_round_id_avatar_address_opponent_avatar");
            ...
            modelBuilder.Entity("ArenaService.Shared.Models.Battle", b =>
                {
                    ...
                    b.HasIndex("RoundId")
                        .HasDatabaseName("ix_battles_round_id");
                    ...
                    b.HasIndex("BattleStatus", "Reviewed")
                        .HasDatabaseName("ix_battles_battle_status_reviewed");

                    b.HasIndex("Id", "TxId")
                        .HasDatabaseName("ix_battles_id_tx_id");
            ...
            modelBuilder.Entity("ArenaService.Shared.Models.BattleTicket.BattleTicketStatusPerRound", b =>
                {
                    ...
                    b.ToTable("battle_ticket_statuses_per_round", null, t =>
                        {
                            t.HasCheckConstraint("CK_BattleTicketStatusPerRound_RemainingCount", "remaining_count >= 0");
                        });
                });
            ...
            modelBuilder.Entity("ArenaService.Shared.Models.Participant", b =>
                {
                    ...
                    b.HasIndex("SeasonId", "Score")
                        ...
                        .HasDatabaseName("ix_participants_season_id_score");
            ...
            modelBuilder.Entity("ArenaService.Shared.Models.RankingSnapshot", b =>
                {
                    ...
                    b.HasIndex("SeasonId")
                        .HasDatabaseName("ix_ranking_snapshots_season_id");
            ...
            modelBuilder.Entity("ArenaService.Shared.Models.RefreshTicket.RefreshTicketStatusPerRound", b =>
                {
                    ...
                    b.ToTable("refresh_ticket_statuses_per_round", null, t =>
                        {
                            t.HasCheckConstraint("CK_RefreshTicketStatusPerRound_RemainingCount", "remaining_count >= 0");
                        });
                });
            ...
            modelBuilder.Entity("ArenaService.Shared.Models.Round", b =>
                {
                    ...
                    b.HasIndex("SeasonId", "RoundIndex")
                        .IsUnique()
                        .HasDatabaseName("ix_rounds_season_id_round_index");
            ...
            modelBuilder.Entity("ArenaService.Shared.Models.Battle", b =>
                {
                    ...
                    b.HasOne("ArenaService.Shared.Models.Round", "Round")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_battles_rounds_round_id");
